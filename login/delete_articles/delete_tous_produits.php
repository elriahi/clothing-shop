...
$pdoQuery = "DELETE FROM `tous_produits` WHERE `id_produit` = :id_produit";
...
if($pdoExec)
{
    header("Location: http://127.0.0.1/projet/login/check_articles/list_articles_tous_produits.php");
}else{
