			...
			<?php
				...
				if (isset($_POST['submit'])) {
					...
					$save_article = $db->prepare('INSERT INTO montres(reference,marque,p_cat,p_subcat,contenu,p_key_word,images_name_montres,prix,quantity,stock,date_creation) VALUES(?,?,?,?,?,?,?,?,?,?,?)');
					...
					$save_article->execute(array($reference,$marque,$p_cat,$p_subcat,$contenu,$p_key_word,$name_file,$prix,$quantity,$stock,$date_creation));
                      ...
                      window.location.href='http://localhost/projet/login/check_articles/list_articles_montres.php';
                      </script>";
		...
		<div class="content">
             ...
             <a type="button" class="btn btn-primary bg-danger" href="/projet/login/check_articles/list_articles_montres.php">retour à la page précédent</a>
			...
			<lable for="floatingTextarea2"><input type="text" name="contenu" placeholder="entrer le contenu de marque" required="" class="form form-control"></label><br><br>
			...
			<lable for="floatingTextarea2"><input type="submit" name="submit" class="btn btn-success"></label><br><br>
			</form>
