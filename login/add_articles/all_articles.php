			...
			<?php
				...
				if (isset($_POST['submit'])) {
					...
					$save_article = $db->prepare('INSERT INTO all_articles(reference,marque,p_cat,p_subcat,contenu,p_key_word,images_name,prix,quantity,stock,date_creation) VALUES(?,?,?,?,?,?,?,?,?,?,?)');
					...
					$save_article->execute(array($reference,$marque,$p_cat,$p_subcat,$contenu,$p_key_word,$name_file,$prix,$quantity,$stock,$date_creation));
                      ...
                      window.location.href='http://localhost/projet/login/check_articles/list_articles.php';
                      </script>";
		...
		<div class="content">
             ...
             <a type="button" class="btn btn-primary bg-danger" href="/projet/login/check_articles/list_articles.php">retour à la page précédent</a>
