			...
			<?php
				...
				if (isset($_POST['submit'])) {
					...
					$save_article = $db->prepare('INSERT INTO arrivals(reference,marque,p_cat,p_subcat,contenu,p_key_word,images_name_arrivals,prix,quantity,stock,date_creation) VALUES(?,?,?,?,?,?,?,?,?,?,?)');
					...
					$save_article->execute(array($reference,$marque,$p_cat,$p_subcat,$contenu,$p_key_word,$name_file,$prix,$quantity,$stock,$date_creation));
                      ...
                      window.location.href='http://localhost/projet/login/check_articles/list_articles_arrivals.php';
                      </script>";
		...
		<div class="content">
             ...
             <a type="button" class="btn btn-primary bg-danger" href="/projet/login/check_articles/list_articles_arrivals.php">retour à la page précédent</a>
