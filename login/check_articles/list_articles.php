    <?php include "../includes/header.php"; ?>
     ...
     <?php
        ...
        $query = "SELECT * FROM all_articles";
     ...
     ?>  
        ...
        <form action="../delete_articles/delete.php" method="POST">
        ...
        <a href="../add_articles/all_articles.php" class="btn btn-warning" role="button">Ajouter un article</a> <br> <br>
        </form>
        </div>
        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <?php 
                 ...
                 while($row = mysqli_fetch_array($query_run)) {
                  ...
                  <td><img src="../images/'.$row['images_name'].' " width="80%"><br><br>
                  <a href="../modifier_p_img/modifier_2.php?modifier='.$row['id_produit'].'"
                  class="btn btn-outline-danger" role="button">Edit</a></td>

                  <td><img src="../images/'.$row['image_small_1'].' "width="80%"><br><br>
                  <a href="../modifier_slidshow_img/modifier_1.php?modifier='.$row['id_produit'].'
                  " class="btn btn-outline-danger" role="button">Edit</a></td>

                  <td><img src="../images/'.$row['image_small_2'].' "width="80%"><br><br>
                  <a href="../modifier_slidshow_img/modifier_2.php?modifier='.$row['id_produit'].'
                  " class="btn btn-outline-danger" role="button">Edit</a></td>

                  <td><img src="../images/'.$row['image_small_3'].' "width="80%"><br><br>
                  <a href="../modifier_slidshow_img/modifier_3.php?modifier='.$row['id_produit'].'
                  " class="btn btn-outline-danger" role="button">Edit</a></td>

                  <td><img src="../images/'.$row['image_small_4'].' "width="80%"><br><br>
                  <a href="../modifier_slidshow_img/modifier_4.php?modifier='.$row['id_produit'].'
                  " class="btn btn-outline-danger" role="button">Edit</a></td>
                 ...
                 <td><a href="../modifier_articles/modifier.php?modifier='.$row['id_produit'].'" class="btn btn-outline-danger" role="button">Edit</a></td>
                 </tr>
