  ...
  <i class="fas fa-arrow-up"></i>
               ...
               <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#main_nav" aria-controls="main_nav" aria-expanded="false" aria-label="             Toggle navigation">
                ...
                ?>
                 ...
                 <li class="nav-item dropdown">
                 <a class="nav-link  dropdown-toggle active" href="" data-bs-toggle="dropdown"><i class="fas fa-user"></i>
                 ...
                 <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="profil.php?order">Mes commandes</a></li>
            ...
            <div class="footer-one col-lg-3 col-md-6 col-12">
             ...
             <div class="footer-one col-lg-3 col-md-6 col-12">
                ...
                <h5 class="pb-2">Accés rapide</h5>
                              <?php if (isset($_SESSION['SESSION_PSEUDO'])):?>
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item pt-auto"><a class="nav-link" href="profil.php">Mon profil</a></li>
                  <li class="nav-item pt-auto"><a class="nav-link" href="profil.php?order">Mes commandes </a></li>
