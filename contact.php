  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <section class="container sproduct my-5 pt-1">
     ...
     <div class="col-lg-5 col-md-12 col-12">
                ...
                <form action="" method="POST">
                    <div class="form-group">
                      <input type="text"  class="form-control"
                       name="name" placeholder="insérez votre nom" required > <br>
                    </div>

                    <div class="form-group">
                      <input type="email"  class="form-control"
                       name="email" placeholder="insérez votre e-mail" required ><br>
                    </div>
                  <div class="form-group">
                      <input type="text"  class="form-control"
                       name="phone" value="+216" required ><br>
                    </div>

                    <div class="form-group">
                      <label for="">Votre Message :</label>
                      <textarea class="form-control" name="msg" rows="3" style="resize: none;" required ></textarea><br>
                    </div>
                    <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-danger" name="submit_btn">Envoyer message</button>
                    </div>
                </form>
            </div>
            ...
            <img  class="img-fluid w-100 pb-1" src="img/contact.png">
