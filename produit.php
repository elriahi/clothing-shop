...
if (isset($_GET['id'])) {
    ...
    $get_pro_d = "select * from  tous_produits where id_produit = '$id' ";
...
<section class="container sproduct my-5 pt-1">
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-6 col-md-12 col-12">
            ...
            <a href="produit.php?add_cart=<?php echo $row_pro_d['id_produit']; ?>" style="color: white;" name="btn_cart" class="btn buy-btn" role="button">Ajouter à panier</a>
