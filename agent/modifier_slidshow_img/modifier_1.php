...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE all_articles SET image_small_1=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <div class="content" class="form-floating">
             <form method="POST" action="modifier_1.php?modifier=<?php echo $all_articles['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $all_articles['id_produit']; ?>" class="form form-control">
             <img src="../../login/images/<?php echo $all_articles['image_small_1'];?> "width="20%">
             <lable for="floatingTextarea2"><input type="file" name="name_file"></label> <br><br>
             <lable for="floatingTextarea2"><input type="submit" name="submit" class="btn btn-primary bg-success" style="float: left;" value="Mise a jour S1" ></label>&nbsp;
