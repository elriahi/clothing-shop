...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE montres SET image_small_3=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <a href="../check_articles/list_articles_montres.php" class="btn btn-light" role="button">liste des articles : Montres</a><br><br>
             ...
             <form method="POST" action="modifier_11.php?modifier=<?php echo $montres['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $montres['id_produit']; ?>" class="form form-control">
             <img src="../../login/images/<?php echo $montres['image_small_3'];?> "width="20%">
