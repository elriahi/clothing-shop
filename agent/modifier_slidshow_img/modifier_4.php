...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE all_articles SET image_small_4=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <div class="content" class="form-floating">
             <form method="POST" action="modifier_4.php?modifier=<?php echo $all_articles['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $all_articles['id_produit']; ?>" class="form form-control">
             <img src="../../login/images/<?php echo $all_articles['image_small_4'];?> "width="20%">
