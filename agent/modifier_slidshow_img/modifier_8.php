...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE arrivals SET image_small_4=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <a href="../check_articles/list_articles_arrivals.php" class="btn btn-light" role="button">liste des articles : Arrivals</a><br><br>
             ...
             <form method="POST" action="modifier_8.php?modifier=<?php echo $arrivals['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $arrivals['id_produit']; ?>" class="form form-control">
                    <img src="../../login/images/<?php echo $arrivals['image_small_4'];?> "width="20%">
