...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE robes SET image_small_2=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <a href="../check_articles/list_articles_robes.php" class="btn btn-light" role="button">liste des articles : Robes</a><br><br>

             <form method="POST" action="modifier_14.php?modifier=<?php echo $robes['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $robes['id_produit']; ?>" class="form form-control">
             <img src="../../login/images/<?php echo $robes['image_small_2'];?> "width="20%">
