...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE tous_produits SET image_small_3=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <a href="../check_articles/list_articles_tous_produits.php" class="btn btn-light" role="button">liste des articles : Tous les produits</a><br><br>
             ...
             <form method="POST" action="modifier_19.php?modifier=<?php echo $tous_produits['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $tous_produits['id_produit']; ?>" class="form form-control">
             <img src="../images/<?php echo $tous_produits['image_small_3'];?> "width="20%">
