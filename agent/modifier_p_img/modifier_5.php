...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE montres SET images_name_montres=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <div class="content" class="form-floating">
             <form method="POST" action="modifier_5.php?modifier=<?php echo $montres['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $montres['id_produit']; ?>" class="form form-control">
             <img src="../../login/images/<?php echo $montres['images_name_montres'];?> "width="20%"><br>
             ...
             <a type="button" class="btn btn-primary bg-danger" href="/projet/login/check_articles/list_montress.php">Précdent</a>
             <br><br>
