...
<?php
    ...
    // Count total files
        ...
        $pdoQuery = "UPDATE tous_produits SET images_name=:name_file WHERE id_produit=:id_produit ";
        ...
        else
        {
            ...
            <div class="content" class="form-floating">
             <form method="POST" action="modifier_1.php?modifier=<?php echo $tous_produits['id_produit']; ?>" enctype="multipart/form-data">
             <input type="hidden" name="id_produit" value="<?php echo $tous_produits['id_produit']; ?>" class="form form-control">
             <img src="../../login/images/<?php echo $tous_produits['images_name'];?> "width="20%"><br>
             <lable for="floatingTextarea2"><input type="file" name="name_file"></label> <br><br>
             <lable for="floatingTextarea2"><input type="submit" name="submit" class="btn btn-primary bg-dark" style="float: left;" value="Mise a jour S1" ></label>
             <a type="button" class="btn btn-primary bg-danger" href="/projet/login/check_articles/list_articles_tous_produits.php">Précdent</a>
             <br><br>
