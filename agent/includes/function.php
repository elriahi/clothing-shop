...
if(isset($_GET['add_cart'])) {
    ...
    $p_reference_2 = $row_pro_price['reference'];
    $marque2 = $row_pro_price['marque'];
...
if(isset($_GET['add_cart'])) {
    ...
    $p_reference_3 = $row_pro_price['reference'];
    $marque3 = $row_pro_price['marque'];
...
if(isset($_GET['add_cart'])) {
    ...
    $run_price_pro_2 = mysqli_query($db, $price_pro_2);
    while($row_pro_price_2 = mysqli_fetch_array($run_price_pro_2)) {
    $p_reference_4 = $row_pro_price['reference'];
    $marque4 = $row_pro_price['marque'];
    $p_single_p_R = $row_pro_price_2['prix'];
     }
...
if(isset($_GET['add_cart'])) {
    ...
    $run_price_pro_2 = mysqli_query($db, $price_pro_2);
    while($row_pro_price_2 = mysqli_fetch_array($run_price_pro_2)) {
    $p_reference_5 = $row_pro_price['reference'];
    $marque5 = $row_pro_price['marque'];
    $p_single_p_M = $row_pro_price_2['prix'];
     }
