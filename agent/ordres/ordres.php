...
<!-- Connect DB for the next form Query Categories -->
    ...
    $query = "SELECT * FROM commande_en_cours";
...
<!-- Connect DB for the next form Query Categories -->
     ...
     <div class="content">
        <form action="add_order.php" method="POST">
            <input type="submit" name="ajouter" class="btn btn-success" value="Ajouter commande" class="">
        </form> 
        <br>
        ...
        <h5>Liste commandes en attentes</h5>
            ...
            <?php
               ...
               while($row = mysqli_fetch_array($result)) {
                ...
                echo '
                  ...
                  <td style="text-align:center">'.$row['id_membre'].'</td>
                  ...
                  <td style="text-align:center">'.$row['p_cat'].'</td>
                  <td style="text-align:center">'.$row['qty'].'</td>
                  <td style="text-align:center">'.$row['size'].'</td>
                  <td style="text-align:center">'.$row['due_amount'].' DT</td>
                  <td style="text-align:center"><a href="edit_order.php?edit='.$row['order_id'].'" class="btn btn-outline-danger" role="button">Edit</a></td>
                  <td style="text-align:center"><a href="ajouter_livraison.php?ajouter='.$row['order_id'].'" class="btn btn-outline-success" role="button">ajouter</a><br>'.$row['order_status'].'</td>
                  </tr>
