...
if (isset($_GET['id'])) {
    ...
    $get_pro_d = "select * from all_articles where id_produit = '$id' ";
...
<section class="container sproduct my-5 pt-4">
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-5 col-md-12 col-12">
           ...
           <img class="img-fluid w-100 pb-1" src="<?php echo 'login/images/'.$row_pro_d['images_name']; ?>" id="MainImg" alt="Produit photo">
           ...
           <div class="small-img-col">
                <!-- img small (3) -->
           <img  src="<?php echo 'login/images/'.$row_pro_d['image_small_3']; ?>" width="100%" class="small-img" alt="small image 2">
               </div>
           <div class="small-img-col">
                <!-- img small (4) -->
           <img  src="<?php echo 'login/images/'.$row_pro_d['image_small_4']; ?>" width="100%" class="small-img" alt="small image 2">
       </div>
        </div>
      </div>
        ...
        <div class="col-lg-6 col-md-12 col-12">
            ...
            <a href="p_populaires.php?add_cart=<?php echo $row_pro_d['id_produit']; ?>" style="color: white;" name="btn_cart" class="btn buy-btn" role="button">Ajouter à panier</a>
